...
export const useIndexDBStore = defineStore('indexedDB ', () => {
  ...
  async function storeKeyPair() {
    return new Promise<void>((resolve, reject) => {
      ...
      store.add(encryption_store.keypair?.publicKey, 'publicKey')
      store.add(encryption_store.keypair?.secretKey, 'privateKey')
